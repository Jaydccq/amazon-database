...
class Review:
    ...
    def create(user_id, comment, product_id=None, seller_id=None, rating=None):
        ...
        try:
            rows = app.db.execute('''
            INSERT INTO Reviews_Feedbacks(user_id, comment, product_id, seller_id, rating, review_date)
            VALUES(:user_id, :comment, :product_id, :seller_id, :rating, CURRENT_TIMESTAMP)
            RETURNING review_id
            ''',
                                  user_id=user_id,
                                  comment=comment,
